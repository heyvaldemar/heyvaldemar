...
**Today: 73 restore scripts across 48 repositories, every one of them run by CI.** 833 releases are tagged across the fleet. fleet-ops recounts these once a day and rewrites this line when a number changes; these last changed 2026-09-24 00:52 UTC.
<!-- fleet-evidence:end -->
