...
<!-- fleet-summary:start -->
**[85 repositories under this standard](https://github.com/heyvaldemar/catalog)** — 47 self-hosted applications behind Traefik, 14 game servers, 5 other stacks, 8 Terraform pipelines on AWS, 11 operations tools and scripts. Every template is pinned by digest, boots in CI daily, upgrades from its previous release on the same volumes, and is released only after that passes. fleet-ops recounts them once a day and rewrites this line when a number changes; these last changed 2026-09-23 01:03 UTC.
<!-- fleet-summary:end -->
